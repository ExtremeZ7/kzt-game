//———————————————————————–
// <copyright file=”CollisionListener.cs” game="KzzzZZZzzT!">
...
public class CollisionListener : MonoBehaviour
{
    ...
    //fields
    [Header("Collision Listener")]
    #if UNITY_EDITOR
    [DisplayScriptName]
    #endif
    [Tooltip("The Trigger Switches to listen to")]
    public CollisionSwitch[] switches;
    ...
    void OnEnable()
    {
        CollisionListenerManager.Instance.Register(this);
    }

    void OnDisable()
    {
        CollisionListenerManager.Instance.Unregister(this);
    ...
    void OnValidate()
    {
        ...
        {
            switches = new CollisionSwitch[1];
        }
    ...
    protected class ListenerRunner
    {
        ...
        readonly CollisionListener listener;
        float pauseTime;

        //constructor
        public ListenerRunner(CollisionListener listener)
        {
        ...
        IEnumerator CheckSwitches()
        {
            for (;;)
            {
                ...
                {
                    CollisionSwitch triggerSwitch = listener.switches[i];
