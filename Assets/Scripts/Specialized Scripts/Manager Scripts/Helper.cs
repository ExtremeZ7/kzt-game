...
public static class Helper : System.Object
{
    ...
    public class Res
    {
        ...
        const string characterHeads = "Character Heads/";

        public UnityEngine.Object KrazyKrystal
        {
            get{ return Resources.Load(crystalIcons + "krazy_krystal"); }
        }

        public UnityEngine.Object ItemIcon(int itemIndex, int levelIndex, int worldIndex)
        {
            //Incomplete
            switch (levelIndex)
            {
