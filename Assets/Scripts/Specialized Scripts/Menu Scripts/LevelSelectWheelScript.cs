...
public class LevelSelectWheelScript : MonoBehaviour
{
    ...
    void SetSprites(int levelIndex, int worldIndex)
    {
        ...
        transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = 
			(Helper.res.CharacterHeads(worldIndex)) as Sprite;
        ...
        //Set Gem Sprite
        items[0].GetChild(0).gameObject.GetComponent<SpriteRenderer>().sprite = Helper.res.ItemIcon(0, levelIndex, worldIndex) as Sprite;
