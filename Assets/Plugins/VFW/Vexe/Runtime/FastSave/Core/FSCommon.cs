    ...
    public static class FSCommon
    {
        ...
        static FSCommon()
        {
            ...
            ecs.Add<Transform>("position", "eulerAngles", "localScale")
               ...
               .Add<ParticleSystem>("shadowCastingMode", "receiveShadows", "sharedMaterials", "useLightProbes", "reflectionProbeUsage", "probeAnchor", "cameraVelocityScale", "particleRenderMode", "lengthScale", "velocityScale", "maxParticleSize", "uvAnimationCycles", "uvAnimationXTile", "uvAnimationYTile", "uvTiles")
               .Add<ParticleSystem>("doesAnimateColor", "colorAnimation", "worldRotationAxis", "localRotationAxis", "rndForce", "force", "sizeGrow", "damping", "autodestruct")
